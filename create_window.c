...
/*   Updated: 2023/04/09 05:19:48 by pferreir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_game(t_data d)
{
	...
	d.ih = 64;
	d.mlx = mlx_init();
	d.win = mlx_new_window(d.mlx, 64 * d.nbcol, 64 * d.nbline, "so_long");
	...
	d.shark = mlx_xpm_file_to_image(d.mlx, "./image/shark.xpm", &d.ih, &d.iw);
